...
export default function Download() {
  return <Generic title="下载">
    <div>
      <p>影视投是基于物联网、云计算、大数据与区块链技术，通过运用<strong>区块链</strong>的分布式账本体系与智能合约模型，结合<strong>物联网</strong>、大数据及人工智能等前沿技术，致力于打造具有信任高、效率高、成本低的影视产权及产权权益投融<strong>数字化交易管理平台</strong>。</p>
      <h4>影视投网络的主要特点：</h4>
